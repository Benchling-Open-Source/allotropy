...
In order to contribute you will need to have an Individual or Corporate Contributor License Agreement (CLA) on file with Benchling depending on if you are contributing on your own time or as part of another company. You can email opensource@benchling.com to get this process started, or if you do not have a
CLA on file when you open your first pull request, Benchling will reach out!
