...
from allotropy.parsers.test_5.test_5_structure import Data
from allotropy.parsers.test_5.constants import DISPLAY_NAME
from allotropy.parsers.utils.uuids import random_uuid_str
from allotropy.parsers.vendor_parser import VendorParser


class Test5Parser(VendorParser):
    @property
    ...
    def _get_model(self, data: Data) -> Model:
        return Model(
            field_asm_manifest="http://purl.allotrope.org/manifests/pcr/BENCHLING/2023/09/qpcr.manifest",
