...
#   timestamp: 2023-10-24T06:17:37+00:00
...
from allotropy.allotrope.models.shared.definitions.custom import (
    ...
    TQuantityValueRelativeFluoresenceUnit,
...
class MeasurementDocumentItem:
    ...
    absorbance: Optional[TQuantityValueMilliAbsorbanceUnit] = None
    fluorescence: Optional[TQuantityValueRelativeFluoresenceUnit] = None
    luminescence: Optional[TQuantityValueRelativeLightUnit] = None
...
class Model:
    ...
    manifest: str = (
        "http://purl.allotrope.org/manifests/plate-reader/2023/09/plate-reader.manifest"
    )
