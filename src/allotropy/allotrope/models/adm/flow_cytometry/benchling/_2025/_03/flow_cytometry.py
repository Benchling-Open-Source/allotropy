...
#   timestamp: 2025-02-28T19:56:02+00:00
...
class VertexDocumentItem:
    x_coordinate: TQuantityValueMilliAbsorbanceUnit | TQuantityValueRelativeFluorescenceUnit | None = (
        None
    )
    y_coordinate: TQuantityValueMilliAbsorbanceUnit | TQuantityValueRelativeFluorescenceUnit | None = (
        None
    )
...
class PopulationDocumentItem:
    ...
    statisticsAggregateDocument: StatisticsAggregateDocument | None = None
...
class MeasurementAggregateDocument:
    ...
    analytical_method_identifier: TStringValue | None = None
    experimental_method_identifier: TStringValue | None = None
