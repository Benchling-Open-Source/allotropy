...
#   timestamp: 2024-06-06T15:12:24+00:00
...
class PeakItem:
    ...
    peak_assignment_identifier: TStringValue | None = None
    ...
    relative_peak_height: TQuantityValueNumber | TQuantityValueSecondTime | None = None
    peak_start: TQuantityValueNumber | TQuantityValueSecondTime | None = None
    peak_end: TQuantityValueNumber | TQuantityValueSecondTime | None = None
    peak_position: TQuantityValueNumber | TQuantityValueSecondTime | None = None
...
class DataRegionDocumentItem:
    ...
    written_name: TStringValue | None = None
    region_start: TQuantityValueNumber | TQuantityValueSecondTime | None = None
    region_end: TQuantityValueNumber | TQuantityValueSecondTime | None = None
