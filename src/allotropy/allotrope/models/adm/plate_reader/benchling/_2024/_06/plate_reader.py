...
#   timestamp: 2024-08-09T20:42:26+00:00
...
class PeakItem(OrderedItem):
    peak_height: MilliAbsorbance | TQuantityValueRelativeFluorescenceUnit | None = None
...
@dataclass(kw_only=True)
class FluorescenceCubeDetectorMeasurementDocumentItems1:
...
FluorescenceCubeDetectorMeasurementDocumentItems = (
    FluorescenceCubeDetectorMeasurementDocumentItems1
    | FluorescenceCubeDetectorMeasurementDocumentItems1
    | FluorescenceCubeDetectorMeasurementDocumentItems1
)
...
@dataclass(kw_only=True)
class AbsorbanceCubeDetectorMeasurementDocumentItems1:
    electropherogram_data_cube: TDatacube | None = None
    device_control_aggregate_document: DeviceControlAggregateDocument | None = None
    processed_data_document: ProcessedDataDocument | None = None
...
AbsorbanceCubeDetectorMeasurementDocumentItems = (
    AbsorbanceCubeDetectorMeasurementDocumentItems1
    | AbsorbanceCubeDetectorMeasurementDocumentItems1
    | AbsorbanceCubeDetectorMeasurementDocumentItems1
)
