...
#   timestamp: 2024-12-09T23:25:22+00:00
...
@dataclass(kw_only=True)
class CustomDataCubeDocumentItem:
    data_cube: TDatacube | None = None


@dataclass(kw_only=True)
class CustomDataCubeAggregateDocument:
    custom_data_cube_document: list[CustomDataCubeDocumentItem] | None = None
...
class OpticalImagingMeasurementDocumentItems:
    ...
    compartment_temperature: TQuantityValueDegreeCelsius | None = None
    mass_concentration: TQuantityValuePicogramPerMilliliter | None = None
    custom_data_cube_aggregate_document: CustomDataCubeAggregateDocument | None = None
