...
#   timestamp: 2025-02-26T16:03:05+00:00
...
class PeakItem(OrderedItem):
    peak_area: TQuantityValueMilliAbsorbanceUnitTimesMilliliter | TQuantityValueMilliAbsorbanceUnitTimesSecond | TQuantityValueRelativeLightUnitTimesMilliliter | TQuantityValueRelativeLightUnitTimesSecond | None = (
        None
    )
    peak_height: TQuantityValueMilliAbsorbanceUnit | TQuantityValueRelativeLightUnit | None = (
        None
    )
