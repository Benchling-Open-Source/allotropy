...
#   timestamp: 2024-08-13T04:08:38+00:00
...
@dataclass(kw_only=True)
class PeakList3:
    peak: list[PeakItem3] | None = None


@dataclass(kw_only=True)
class PeakItem6(OrderedItem):
    peak_height: TQuantityValueRelativeLightUnit | None = None
...
@dataclass(kw_only=True)
class PeakList6:
    peak: list[PeakItem6] | None = None


@dataclass(kw_only=True)
class ProcessedDataDocument6:
    peak_list: PeakList6 | None = None
...
class MeasurementDocument:
    ...
    processed_data_document: ProcessedDataDocument | ProcessedDataDocument3 | ProcessedDataDocument6 | None = (
        None
    )
