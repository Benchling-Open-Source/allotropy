...
#   timestamp: 2024-08-13T06:04:38+00:00
...
class CustomInformationAggregateDocument:
    custom_information_document: list[CustomInformationDocumentItem1]
...
class ImageDocumentItem:
    ...
    index: TIntegerValueModel | None = None
