...
@dataclass(frozen=True, kw_only=True)
class LuminescenceAreaScanDataCube(TDatacube):
    cube_structure: TDatacubeStructure | None = field(
        default=None, metadata={"json_name": "cube-structure"}
    )
...
class PeakItem(OrderedItem):
    ...
    peak_value_at_end: TQuantityValueMilliAbsorbanceUnit | TQuantityValueRelativeFluorescenceUnit | None = (
        None
    )
    peak_value_at_start: TQuantityValueMilliAbsorbanceUnit | TQuantityValueRelativeFluorescenceUnit | None = (
        None
    )
...
class DeviceControlDocumentItem(OrderedItem):
    ...
    polarization_orientation_setting: TNamed | None = None
...
class MeasurementDocumentItem:
    ...
    absorption_area_scan_data_cube: AbsorptionAreaScanDataCube | None = None
    ...
    fluorescence_area_scan_data_cube: FluorescenceAreaScanDataCube | None = None
    ...
    luminescence_area_scan_data_cube: LuminescenceAreaScanDataCube | None = None
