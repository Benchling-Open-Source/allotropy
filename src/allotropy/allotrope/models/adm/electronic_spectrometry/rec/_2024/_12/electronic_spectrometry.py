...
#   filename:  electronic-spectrometry.schema.json
#   timestamp: 2025-02-26T16:05:47+00:00
...
class AdmCoreREC202412ManifestSchema:
...
class MeasurementDocument:
    ...
    fluorescence_excitation_spectrum_data_cube: TDatacube | None = None
    ...
    absorption_spectrum_data_cube: TDatacube | None = None
    transmittance_spectrum_data_cube: TDatacube | None = None
    fluorescence: TQuantityValueRelativeFluorescenceUnit | None = None
    fluorescence_emission_profile_data_cube: TDatacube | None = None
    fluorescence_emission_spectrum_data_cube: TDatacube | None = None
...
@dataclass(kw_only=True)
class ElectronicSpectrometryDocumentItem:
...
@dataclass(kw_only=True)
class ElectronicSpectrometryAggregateDocument:
    electronic_spectrometry_document: list[ElectronicSpectrometryDocumentItem]
...
@dataclass(kw_only=True)
class Model:
    field_asm_manifest: AdmCoreREC202412ManifestSchema | str
    electronic_spectrometry_aggregate_document: ElectronicSpectrometryAggregateDocument | None = (
        None
    )
