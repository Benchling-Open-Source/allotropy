...
#   timestamp: 2025-02-05T18:33:31+00:00
...
DataSourceAggregateDocument = Any
...
class ReportPointDocumentItem:
    absolute_response: TQuantityValueResponseUnits | None = None
    ...
    relative_response: TQuantityValueResponseUnits | None = None
    flow_cell_identifier: TStringValue | None = None
    time_setting: TQuantityValueSecondTime | None = None
    cycle_identifier: TStringValue | None = None
...
@dataclass(kw_only=True)
class SensorgramAggregateDocument:
    sensorgram_document: list[SensorgramDocumentItem] | None = None
...
class MeasurementDocument:
    ...
    sensorgram_aggregate_document: SensorgramAggregateDocument | None = None
