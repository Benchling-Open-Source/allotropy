...
#   timestamp: 2024-07-18T20:01:16+00:00
...
class ProcessedDataDocumentItem:
    viability__cell_counter_: TQuantityValuePercent | None
    viable_cell_density__cell_counter_: TQuantityValueMillionCellsPerMilliliter | None
    data_processing_document: DataProcessingDocument | dict[str, Any] | None = None
    data_source_aggregate_document: DataSourceAggregateDocument | None = None
...
class MeasurementDocument:
    ...
    osmolality: TQuantityValueMilliOsmolesPerKilogram | None
    absorbance: TQuantityValueMilliAbsorbanceUnit | None
    pH: TQuantityValuePH | None
    pO2: TQuantityValueMillimeterOfMercury | None
    pCO2: TQuantityValueMillimeterOfMercury | None
    analyte_aggregate_document: AnalyteAggregateDocument | None
    detection_type: TStringValue | None = None
