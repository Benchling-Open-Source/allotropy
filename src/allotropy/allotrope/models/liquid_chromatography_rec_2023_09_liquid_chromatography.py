...
#   timestamp: 2024-01-09T17:43:03+00:00
...
@dataclass
class ProcessedDataDocumentItem1(OrderedItem):
...
class PeakItem:
    ...
    written_name: Optional[TStringValue] = None
    peak_height: Optional[TStringValue] = None
    capacity_factor__chromatography_: Optional[TQuantityValueUnitless] = None
    peak_area: Optional[PeakArea] = None
