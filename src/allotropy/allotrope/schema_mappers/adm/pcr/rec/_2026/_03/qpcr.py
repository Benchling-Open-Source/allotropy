...
from allotropy.allotrope.models.adm.pcr.rec._2026._03.qpcr import (
...
class Mapper(SchemaMapper[Data, Model]):
    MANIFEST = "http://purl.allotrope.org/manifests/pcr/REC/2026/03/qpcr.manifest"
                ...
                MeasurementAggregateDocument(
                    ...
                    measurement_document=[
                        self._get_measurement_document_item(
                            measurement,
                            metadata,
                            measurement_group.experimental_data_identifier,
                        )
    ...
    def _get_measurement_document_item(
        ...
        sample_doc = add_custom_information_document(
            ...
            measurement.sample_custom_info or {},
        )
        ...
        measurement_doc = MeasurementDocumentItem(
            ...
            processed_data_aggregate_document=assert_not_none(
                self._get_processed_data_aggregate_document(
                    measurement.processed_data,
                    measurement.group_identifier,
                )
            ),
    ...
    def _get_processed_data_aggregate_document(
        self, data: ProcessedData | None, group_identifier: str | None = None
