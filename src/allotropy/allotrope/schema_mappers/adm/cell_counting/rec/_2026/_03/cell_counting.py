...
from allotropy.allotrope.models.adm.cell_counting.rec._2026._03.cell_counting import (
...
class Mapper(SchemaMapper[Data, Model]):
    MANIFEST = "http://purl.allotrope.org/manifests/cell-counting/REC/2026/03/cell-counting.manifest"
    ...
    def _get_processed_data_aggregate_document(
        ...
        processed_data_document = ProcessedDataDocumentItem(
            ...
            group_identifier=measurement.group_identifier,
            ...
            average_viable_cell_diameter__cell_counter_=quantity_or_none(
