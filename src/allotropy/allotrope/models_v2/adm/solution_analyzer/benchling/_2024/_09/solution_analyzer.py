...
class MeasurementDocumentItem(OrderedItem):
    ...
    p_o2: TQuantityValueMmHg | TQuantityValueKPa | None = field(default=None, metadata={"json_name": "pO2"})
    p_co2: TQuantityValueMmHg | TQuantityValueKPa | None = field(default=None, metadata={"json_name": "pCO2"})
