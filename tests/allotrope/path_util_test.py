...
def test_get_model_path_from_schema_path_windows_path() -> None:
    ...
    with mock.patch(
        "allotropy.allotrope.path_util.get_rel_schema_path"
    ) as mock_get_rel:
...
def test_get_model_class_from_schema() -> None:
    ...
    with mock.patch(
        "allotropy.allotrope.path_util.importlib.import_module"
    ) as mock_import:
...
def test_get_model_class_from_schema_windows_path() -> None:
    ...
    with mock.patch(
        ...
        "allotropy.allotrope.path_util.get_model_path_from_schema_path"
